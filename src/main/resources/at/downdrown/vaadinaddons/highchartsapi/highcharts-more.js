...
(function (l, F) {
    ...
    var G = M.prototype, y = y.prototype, V = {
        ...
        getPlotBandPath: function (a, b, c) {
            var d = this.center, e = this.startAngleRad, f = d[2] / 2, i = [q(c.outerRadius, "100%"), c.innerRadius, q(c.thickness, 10)], g = /%$/, k, m = this.isCircular;
        ...
        getPlotLinePath: function (a, b) {
            var c = this, d = c.center, e = c.chart, f = c.getPosition(a), i, g, k;
    ...
    u(G, "init", function (a, b, c) {
        var j;
        var d = b.angular, e = b.polar, f = c.isX, i = d && f, g, k;
        k = b.options;
        var m = c.pane || 0;
        if (d) {
    ...
    h.arearange = v(h.area, {
        ...
        getSegmentPath: function (a) {
            var b, c = [], d = a.length, e = t.prototype.getSegmentPath, f, i;
            i = this.options;
            var g = i.step;
        ...
        drawDataLabels: function () {
            var a = this.data, b = a.length, c, d = [], e = t.prototype, f = this.options.dataLabels, i = f.align, g, k, m = this.chart.inverted;
            if (f.enabled || this._hasPointLabels) {
                for (c = b; c--;)if (g = a[c])if (k = g.plotHigh > g.plotLow, g.y = g.high, g._plotY = g.plotY, g.plotY =
                ...
                for (c = b; c--;)if (g = a[c])if (k = g.plotHigh > g.plotLow, g.dataLabelUpper = g.dataLabel, g.dataLabel = d[c], g.y = g.low, g.plotY = g._plotY, g.below = !k, m) {
    ...
    z = {
        ...
        translate: function () {
            ...
            s(this.points, function (d) {
                var e = o(b.dial, d.dial), f = x(q(e.radius, 80)) * c[2] / 200, i = x(q(e.baseLength, 70)) * f / 100, g = x(q(e.rearLength, 10)) * f / 100, k = e.baseWidth || 3, m = e.topWidth || 1, j = b.overshoot, n = a.startAngleRad +
    ...
    h.boxplot = v(h.column, {
        ...
        drawPoints: function () {
            var a = this, b = a.points, c = a.options, d = a.chart.renderer, e,
                f, i, g, k, m, j, n, h, A, l, J, p, o, u, r, v, t, w, x, z, y, E = a.doQuartiles !== !1, C = parseInt(a.options.whiskerLength, 10) / 100;
            s(b, function (b) {
                h = b.graphic;
                z = b.shapeArgs;
                l = {};
                ...
                r = {};
                y = b.color || a.color;
                if (b.plotY !== F)if (e = b.pointAttr[b.selected ? "selected" : ""], v = z.width, t = B(z.x), w = t + v, x = D(v / 2), f = B(E ? b.q1Plot : b.lowPlot), i = B(E ? b.q3Plot : b.lowPlot), g = B(b.highPlot), k = B(b.lowPlot), l.stroke = b.stemColor || c.stemColor || y, l["stroke-width"] = q(b.stemWidth, c.stemWidth, c.lineWidth), l.dashstyle = b.stemDashStyle || c.stemDashStyle, o.stroke =
                        ...
                        j, u = ["M", t, m, "L", w, m], h)b.stem.animate({d: A}), C && b.whiskers.animate({d: p}), E && b.box.animate({d: J}), b.medianShape.animate({d: u}); else {
    ...
    h.waterfall = v(h.column, {
        type: "waterfall", upColorProp: "fill", pointValKey: "y", translate: function () {
            var a = this.options, b = this.yAxis, c, d, e, f, i, g, k, m, j, n = a.threshold, l = a.stacking;
            h.column.prototype.translate.apply(this);
            k = m = n;
            d = this.points;
            ...
            var b = this.yData, c = this.options.data, d, e = b.length, f, i, g, k, m, j;
        ...
        getAttribs: function () {
            ...
            var a = this, b = a.options, c = b.states, d = b.upColor || a.color, b = l.Color(d).brighten(0.1).get(), e = o(a.pointAttr), f = a.upColorProp;
            e[""][f] = d;
            ...
            var a = this.data, b = a.length, c = D(this.options.lineWidth + this.borderWidth) % 2 / 2, d = [], e, f, i;
            ...
            return d
        }, getExtremes: r, drawGraph: t.prototype.drawGraph
    });
    ...
    h.polygon = v(h.scatter, {
        ...
        }, drawGraph: t.prototype.drawGraph, drawLegendSymbol: l.LegendSymbolMixin.drawRectangle
    });
    ...
    h.bubble = v(h.scatter, {
        ...
        getRadii: function (a, b, c, d) {
            var e, f, i = this.zData, g = [], k = this.options.sizeBy !== "width", m = b - a;
    ...
    M.prototype.beforePadding = function () {
        var a = this, b = this.len, c = this.chart, d = 0, e = b, f = this.isXAxis, i = f ? "xData" :
            "yData", g = this.min, k = {}, m = w.min(c.plotWidth, c.plotHeight), j = Number.MAX_VALUE, n = -Number.MAX_VALUE, h = this.max - g, l = b / h, p = [];
        ...
        s(p, function (a) {
            var b = a[i], c = b.length, k;
            f && a.getRadii(j, n, a.minPxSize, a.maxPxSize);
            if (h > 0)for (; c--;)typeof b[c] === "number" && (k = a.radii[c], d = Math.min((b[c] - g) * l - k, d), e = Math.max((b[c] - g) * l + k, e))
        });
        p.length && h > 0 && !this.isLog && (e -= b, l *= (b + d - e) / b, s([["min", "userMin", d], ["max", "userMax", e]], function (b) {
    ...
    (function () {
        ...
        function b(a, b) {
            var c = this.chart, d = this.options.animation, e = this.group, j = this.markerGroup, n = this.xAxis.center, h = c.plotLeft, l = c.plotTop;
            if (c.polar) {
        ...
        if (h.column)e = h.column.prototype, u(e, "animate", b), u(e, "translate", function (a) {
            var b = this.xAxis, c = this.yAxis.len,
                d = b.center, e = b.startAngleRad, j = this.chart.renderer, h, l;

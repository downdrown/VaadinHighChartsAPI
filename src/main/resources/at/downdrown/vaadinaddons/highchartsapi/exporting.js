 ...
 */
(function (g) {
    var A = g.Chart, t = g.addEvent, B = g.removeEvent, C = HighchartsAdapter.fireEvent, j = g.createElement, p = g.discardElement, v = g.css, l = g.merge, m = g.each, q = g.extend, E = g.splat, F = Math.max, k = document, D = window, G = g.isTouchDevice, H = g.Renderer.prototype.symbols, r = g.getOptions(), y;
    q(r.lang, {
    ...
    q(A.prototype, {
        ...
        getSVGForExport: function (b, a) {
            ...
            var d = this, s = d.options.navigation, l = s.menuItemStyle, n = d.chartWidth, o = d.chartHeight, k = "cache-" + b, i = d[k], u = F(f, g), w, x, p, r = function (a) {

...
(function (h) {
    ...
    s(q.prototype, {
        defaultColorAxisOptions: {
            ...
            !b.rgba.length || !a.rgba.length ? a = b.raw || "none" : (a = a.rgba, b = b.rgba,
                c = b[3] !== 1 || a[3] !== 1, a = (c ? "rgba(" : "rgb(") + Math.round(b[0] + (a[0] - b[0]) * (1 - d)) + "," + Math.round(b[1] + (a[1] - b[1]) * (1 - d)) + "," + Math.round(b[2] + (a[2] - b[2]) * (1 - d)) + (c ? "," + (b[3] + (a[3] - b[3]) * (1 - d)) : "") + ")");
            return a
            ...
            i(a.dataClasses, function (a, h) {
                var i, a = l(a);
                c.push(a);
                if (!a.color)f.dataClassColor === "category" ? (i = d.options.colors, a.color = i[e++], e === i.length && (e = 0)) : a.color =
            ...
            if (a)this.left = d = a.attr("x"), this.top = c = a.attr("y"), this.width = e = a.attr("width"), this.height = a = a.attr("height"),
                this.right = b.chartWidth - d - e, this.bottom = b.chartHeight - c - a, this.len = this.horiz ? e : a, this.pos = this.horiz ? d : c
            ...
            if (f)for (j = f.length; j--;) {
                ...
                c = c[j + 1] || e;
                d = 1 - (c[0] - d) / (c[0] - e[0] || 1);
                d = this.tweenColors(e.color, c.color,
                    d)
            }
            return d
        }, getOffset: function () {
            ...
            return typeof e === "number" ? this.horiz ? ["M", e - 4, this.top - 6, "L", e + 4, this.top - 6, e,
                this.top, "Z"] : ["M", this.left, e, "L", this.left - 6, e + 6, this.left - 6, e - 6, "Z"] : n.prototype.getPlotLinePath.call(this, a, b, d, c)
        }, update: function (a, b) {
            var d = this.chart, c = d.legend;
            i(this.series, function (a) {
                a.isDirtyData = !0
            });
            if (a.dataClasses && c.allItems)i(c.allItems, function (a) {
            ...
            var a =
                this, b = this.chart, d = this.legendItems, c = b.options.legend, e = c.valueDecimals, f = c.valueSuffix || "", g;
    ...
    x(y.prototype, "getAllItems", function (a) {
        ...
        d && (d.options.dataClasses ? b = b.concat(d.getDataClassLegendSymbols()) :
            b.push(d), i(d.series, function (a) {
    ...
    r = {
        ...
        translateColors: function () {
            ...
            i(this.data, function (e) {
                var f = e[c];
                if (f = e.options.color || (f === null ? b : d && f !== void 0 ? d.toColor(f, e) : e.color || a.color))e.color = f
            })
        }
    };

...
public class HighChartsAPIConnector extends AbstractComponentConnector {
	...
	HighChartsAPIServerRpc rpc = RpcProxy.create(HighChartsAPIServerRpc.class, this);

	public HighChartsAPIConnector() {
		
		// To receive RPC events from server, we register ClientRpc implementation 
		registerRpc(HighChartsAPIClientRpc.class, new HighChartsAPIClientRpc() {
	...
	protected Widget createWidget() {
		return GWT.create(HighChartsAPIWidget.class);
	}

	
	// We must implement getWidget() to cast to correct type
	@Override
	public HighChartsAPIWidget getWidget() {
		return (HighChartsAPIWidget) super.getWidget();
	}
